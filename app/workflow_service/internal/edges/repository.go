...
func (e *EdgeRepositoryImpl) GetEdgesByWorkflowId(workflowId string) ([]ResponseEdges, error) {
	statement := sq.
	...
	return repository.DbExecAndReturnMany[ResponseEdges](
		e.DB,
		statement,
	)
}
...
func (e *EdgeRepositoryImpl) InsertEdges(tx *sqlx.Tx, edges []Edges) ([]Edges, error) {
