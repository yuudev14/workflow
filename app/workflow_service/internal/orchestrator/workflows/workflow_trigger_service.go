...
func NewWorkflowApplicationService(WorkflowService workflows.WorkflowService, TaskService tasks.TaskService, EdgeService edges.EdgeService, DB *sqlx.DB, mqInstance mq.MQStruct) WorkflowApplicationService {
