...
from src.grpc.workflows import workflow_pb2 as workflow__pb2
...
class WorkflowStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.HandleWorkflow = channel.unary_unary(
...
def add_WorkflowServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HandleWorkflow': grpc.unary_unary_rpc_method_handler(
    ...
    server.add_registered_method_handlers('Workflow', rpc_method_handlers)
