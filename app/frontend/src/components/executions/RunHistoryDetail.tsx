...
// panel. Driven by a playbookHistoryId prop so it works both on the /history
// route and inside the run-history modal.
const RunHistoryDetail: React.FC<{ playbookHistoryId: string }> = ({
  playbookHistoryId,
}) => {
